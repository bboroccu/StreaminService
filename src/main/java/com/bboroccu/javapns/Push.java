package com.bboroccu.javapns;

import java.util.*;

import com.bboroccu.javapns.communication.exceptions.CommunicationException;
import com.bboroccu.javapns.communication.exceptions.KeystoreException;
import com.bboroccu.javapns.devices.Device;
import com.bboroccu.javapns.devices.Devices;
...
import com.bboroccu.javapns.feedback.AppleFeedbackServer;
import com.bboroccu.javapns.feedback.AppleFeedbackServerBasicImpl;
import com.bboroccu.javapns.feedback.FeedbackServiceManager;
import com.bboroccu.javapns.notification.*;
import com.bboroccu.javapns.notification.transmission.NotificationThread;
import com.bboroccu.javapns.notification.transmission.NotificationThreads;
import com.bboroccu.javapns.notification.transmission.PushQueue;
...
public class Push {
	 ...
	 * @param devices a list or an array of tokens or devices: {@link java.lang.String String[]}, {@link java.util.List}<{@link java.lang.String}>, {@link Device Device[]}, {@link java.util.List}<{@link Device}>, {@link java.lang.String} or {@link Device}
	 ...
	 * @param password the keystore's password.
	 * @param production true to use Apple's production servers, false to use the sandbox servers.
	 * @param payloadDevicePairs a list or an array of PayloadPerDevice: {@link java.util.List}<{@link PayloadPerDevice}>, {@link PayloadPerDevice PayloadPerDevice[]} or {@link PayloadPerDevice}
	 * @return a list of pushed notifications, each with details on transmission results and error (if any)
	 * @throws KeystoreException thrown if an error occurs when loading the keystore
	 * @throws CommunicationException thrown if an unrecoverable error occurs while trying to communicate with Apple servers
	 */
