...
import com.bboroccu.javapns.notification.exceptions.ErrorResponsePacketReceivedException;
...
public class PushedNotification {
	...
	public String toString() {
		...
		msg.append(" to token " + device.getToken().substring(0, 5) + "src/main" + device.getToken().substring(59, 64));
		if (response != null) {
