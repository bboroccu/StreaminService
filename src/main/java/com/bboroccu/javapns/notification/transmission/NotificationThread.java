package com.bboroccu.javapns.notification.transmission;
...
public class NotificationThread implements Runnable, PushQueue {
	 ...
	 * @param notificationManager the notification manager to use
	 * @param server the server to communicate with
	 * @param messages a list or an array of PayloadPerDevice: {@link java.util.List}<{@link PayloadPerDevice}>, {@link PayloadPerDevice PayloadPerDevice[]} or {@link PayloadPerDevice}
	 */
