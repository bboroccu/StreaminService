 ...
 * 
 * <p>The list of devices is spread evenly into multiple {@link NotificationThread}s.</p>
 * 
 * <p>Usage: once a NotificationThreads is created, invoke {@code start()} to start all {@link NotificationThread} threads.</p>
 * <p>You can provide a {@link NotificationProgressListener} to receive events about the work being done.</p>
